...
public class conectaRDS {
    public static void main(String[] args) throws SQLException {
        System.out.println("INICIO DE EJECUCIÓN.");
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conexion = DriverManager.getConnection("jdbc:mysql://jmvrdsj.crxrvjghnlol.us-east-2.rds.amazonaws.com:3306/agenda", "JMV", "Tite62Man");
